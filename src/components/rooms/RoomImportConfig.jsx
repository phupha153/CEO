...
export const templateData = [
  {
    ...
    "ราคา": "ระบุตัวเลข (ไม่ต้องมี ,)",
    "ขนาด": "ระบุตัวเลข หรือเว้นว่าง",
    "ค่าน้ำเหมา": "ระบุ ใช่ หรือ ไม่ใช่",
    "จำนวนค่าน้ำเหมา": "หากเหมาระบุตัวเลข หากไม่เว้นว่าง",
    "ค่าไฟเหมา": "ระบุ ใช่ หรือ ไม่ใช่",
    "จำนวนค่าไฟเหมา": "หากเหมาระบุตัวเลข หากไม่เว้นว่าง",
    "ค่าน้ำต่อหน่วย": "ระบุตัวเลข หรือเว้นว่าง",
    "ค่าไฟต่อหน่วย": "ระบุตัวเลข หรือเว้นว่าง",
