...
              {/* Quick Actions Bar - อยู่ในกล่อง Card */}
              {isSelectionMode && (
                <div className="relative z-10 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-4 border-2 border-blue-300 shadow-md">
