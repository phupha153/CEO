...
import { getPrintStyles } from "@/components/contracts/PrintStyles";
...
กรุณาส่งคืนข้อมูลที่แก้ไขแล้ว พร้อมอธิบายสิ่งที่เปลี่ยนแปลง`,
  ...
  const handleConfirmAiChanges = async () => {
    ...
    if (tenant && room) {
      ...
      <div class="contract-page" style="position: relative; width: 21cm; min-height: 29.7cm; padding: 1.5cm 1.5cm 2cm 1.5cm; page-break-after: avoid; page-break-inside: avoid; background: white; box-sizing: border-box;">
...
<div style="font-family: 'TH Sarabun New', 'Sarabun', sans-serif; font-size: 12pt; line-height: 1.6;">
  ...
  <div class="contract-page" style="position: relative; width: 21cm; min-height: 29.7cm; padding: 1.5cm 1.5cm 2cm 1.5cm; page-break-after: avoid; page-break-inside: avoid; background: white; box-sizing: border-box;">
    ...
    <p style="position: absolute; bottom: 1cm; right: 1.2cm; font-size: 11pt; margin: 0;">หน้า ๓/๓</p>
  </div>
