                                ...
                                <div className="flex-1 min-w-0">
                                 <div className="flex items-center gap-2 mb-1 flex-wrap">
                                  ...
                                  <div className="bg-amber-100 border border-amber-300 rounded-lg px-3 py-2 mt-2" onClick={(e) => e.stopPropagation()}>
                                    <div className="flex items-start gap-2 mb-2"><AlertTriangle className="w-4 h-4 text-amber-600 flex-shrink-0 mt-0.5" /><span className="text-amber-800 text-xs font-medium flex-1">{payment.notes.split('\n\n').find(n => n.includes('⚠️'))}</span></div>
