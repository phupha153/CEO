...
const PERMISSIONS_LIST = [
  ...
  { id: 'payments_send_reminder', label: 'ส่งแจ้งเตือนการชำระเงิน', category: 'การชำระเงิน' },
...
const DEFAULT_PERMISSIONS_MAP = {
  ...
  manager: [
    ...
    "payments_view", "payments_add", "payments_edit", "payments_confirm_paid", "payments_send_reminder", "payments_send_receipt", "payments_generate_bills",
