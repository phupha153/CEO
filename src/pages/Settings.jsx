...
export default function Settings() {
  ...
  useEffect(() => {
    ...
    const defBranchConf = configs.find(c => c.key === 'default_communication_branch' && c.branch_id === selectedBranch?.id) || configs.find(c => c.key === 'default_communication_branch' && !c.branch_id);
