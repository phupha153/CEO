...
const PERMISSIONS_LIST = [
  ...
  { id: 'payments_confirm', label: 'ยืนยันชำระเงิน (กดปุ่มเขียว "ชำระแล้ว")', category: 'การชำระเงิน' },
  ...
  { id: 'payments_autocalculate', label: 'คำนวณค่าใช้จ่ายอัตโนมัติ', category: 'การชำระเงิน' },
  { id: 'payments_generate_bills', label: 'สร้างบิลรายเดือนอัตโนมัติ', category: 'การชำระเงิน' },
  { id: 'payments_send_bills_bulk', label: 'ส่งบิลรายบุคคล/ทุกห้องพร้อมกัน (Manual)', category: 'การชำระเงิน' },
...
const DEFAULT_PERMISSIONS_MAP = {
  ...
  manager: [
    ...
    "payments_view", "payments_add", "payments_edit", "payments_confirm", "payments_send_receipt", "payments_view_invoice", "payments_view_receipt", "payments_autocalculate", "payments_generate_bills", "payments_send_bills_bulk", "payments_send_reminder",
  ...
  employee: [
    ...
    "payments_view", "payments_send_receipt", "payments_view_invoice", "payments_view_receipt",
    "meter_readings_view", "meter_readings_add", "meter_readings_edit", "meter_readings_edit_history",
    "expenses_view",
