...
const PERMISSIONS_LIST = [
  ...
  { id: 'payments_send_reminder', label: 'ส่งแจ้งเตือนชำระเงิน (รายบุคคล)', category: 'การชำระเงิน' },
  ...
  { id: 'payments_send_bills_bulk', label: 'ส่งบิลทุกห้องพร้อมกัน (หลังสร้างบิล)', category: 'การชำระเงิน' },
...
const DEFAULT_PERMISSIONS_MAP = {
  ...
  manager: [
    ...
    "payments_view", "payments_add", "payments_edit", "payments_confirm_paid", "payments_send_reminder", "payments_send_receipt", "payments_generate_bills", "payments_send_bills_bulk",
