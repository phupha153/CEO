          ...
          <Card className="bg-white/80 backdrop-blur-xl shadow-2xl border-white/60">
            <CardContent className="p-6">
              ...
              {activeTab === 'messaging' && (
                <MessagingTab
                  userRole={userRole}
                  applyToAllBranches_line={applyToAllBranches_line}
                  setApplyToAllBranches_line={setApplyToAllBranches_line}
                  applyToAllBranches_facebook={applyToAllBranches_facebook}
                  setApplyToAllBranches_facebook={setApplyToAllBranches_facebook}
                  selectedBranch={selectedBranch}
                  canSetGlobalConfig={canSetGlobalConfig}
                  defaultCommunicationBranch={defaultCommunicationBranch}
                  setDefaultCommunicationBranch={setDefaultCommunicationBranch}
                  branches={branches}
                  branchOwnerStatus={branchOwnerStatus}
                  currentUser={currentUser}
                  queryClient={queryClient}
                  lineSettings={lineSettings}
                  setLineSettings={setLineSettings}
                  showWebhookUrl={showWebhookUrl}
                  setShowWebhookUrl={setShowWebhookUrl}
                  handleLineSettingsSubmit={handleLineSettingsSubmit}
                  isSavingLineSettings={isSavingLineSettings}
                  facebookSettings={facebookSettings}
                  setFacebookSettings={setFacebookSettings}
                  buildingLogo={buildingLogo}
                  buildingInfo={buildingInfo}
                  handleFacebookSettingsSubmit={handleFacebookSettingsSubmit}
                  isSavingFacebookSettings={isSavingFacebookSettings}
                  updateConfigMutation={updateConfigMutation}
                  configs={configs}
                  myOwnedBranches={myOwnedBranches}
                />
              )}
