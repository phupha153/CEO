      ...
      <div className="receipt-container mx-auto p-2 md:p-8 print:p-0 max-w-[380px] md:max-w-[800px]">
        <div ref={receiptRef} className="receipt-card bg-white rounded-lg shadow-xl print:shadow-none overflow-hidden">
          <div className="p-3 md:p-8 print:p-5">
            ...
            <div className="mb-2 md:mb-3 p-2 md:p-3 bg-green-50 rounded-lg border border-green-200">
              <p className="text-[9px] md:text-xs font-semibold text-slate-700 mb-1">ชำระเงินผ่าน</p>
              <div className="space-y-0.5 text-[8px] md:text-xs text-slate-700">
                <p><span className="font-medium">ธนาคาร:</span> {receiptData.bank?.name || 'ไม่ระบุ'}</p>
                <p><span className="font-medium">เลขบัญชี:</span> {receiptData.bank?.account_number || 'ไม่ระบุ'}</p>
                <p><span className="font-medium">ชื่อบัญชี:</span> {receiptData.bank?.account_name || 'ไม่ระบุ'}</p>
              </div>
            </div>
            ...
            <div className="pt-2 md:pt-4 text-center">
              <p className="text-[8px] md:text-xs text-slate-500">ขอบคุณที่ใช้บริการ <span className="hidden md:inline">{receiptData.recipient?.building_name || buildingName}</span></p>
            </div>
          </div>
        </div>
      </div>
