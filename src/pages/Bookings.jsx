...
ตอบเป็นภาษาไทย กระชับ ถูกต้อง แม่นยำ`;
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-100 via-blue-50 to-blue-100">
      ...
      {/* Dialog ยืนยันผู้เช่ารายเดือน */}
      <Dialog open={confirmTenantDialog} onOpenChange={setConfirmTenantDialog}>
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2">
                  ...
                  >
                    ...
                    <SelectContent>
                      <SelectItem value={null}>🆓 ไม่เลือกผู้เช่า (สร้างใหม่)</SelectItem>
