            ...
            <div className="text-center mb-6 md:mb-8 px-4">
              ...
              <div className="flex justify-center mt-5 px-4">
                <div className="w-full max-w-3xl overflow-x-auto scrollbar-hide">
                  <div className="bg-gradient-to-r from-white via-white to-slate-50 my-2 p-1.5 rounded-full inline-flex items-center gap-1.5 sm:gap-2 sm:p-2 shadow-lg shadow-orange-200/30 border border-white/60 backdrop-blur-sm min-w-max">
                    {[
