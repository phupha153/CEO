            ...
            <SidebarGroup>
              ...
              <SidebarMenu>
                  ...
                  if (item.isCollapsible && item.subItems) {
                    ...
                    const hasActiveSubItem = item.subItems?.some(sub => location.pathname === sub.url.split('?')[0]);
                    ...
                    return (
                      <SidebarMenuItem key={item.title}>
                        ...
                        >
                          ...
                          <ChevronDown className={`w-4 h-4 ml-auto transition-transform group-data-[collapsible=icon]:hidden ${isOpen ? 'rotate-180' : ''}`} />
                        </SidebarMenuButton>
                        {isOpen && (
                          <SidebarMenuSub>
                                ...
                                <SidebarMenuSubItem key={subItem.title}>
                                  <SidebarMenuSubButton
                                    ...
                                    className={`cursor-pointer ${
                                      isSubActive ? 'bg-blue-100 text-blue-700 font-medium' : ''
                                    }`}
                                  >
