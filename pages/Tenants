...
                    <Button variant="outline" className="text-slate-400 my-1 text-sm font-medium rounded-md inline-flex items-center justify-center gap-2 whitespace-nowrap transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 hover:bg-accent hover:text-accent-foreground h-10 w-10">
...
                                            <div className={`p-3 rounded-lg ${
                                          paymentStatus.isOverdue ? 'bg-red-100 border-red-300' : 'bg-yellow-100 border-yellow-300'} border`
                                          }>
